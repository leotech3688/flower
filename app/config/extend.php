...
return array(
		'cssAliases' => array(  //  样式文件别名配置
				...
				'jquery.validator'			 => 'assets/css/jquery.validator.css',
				'font-awesome'				 => 'assets/css/font-awesome.min.css',
				'font-awesome-ie7'			 => 'assets/css/font-awesome-ie7.min.css',
		),
		...
		'jsAliases'  => array(  //  脚本文件别名配置
				...
				'superslide.2.1'    	=> 'assets/js/superslide.2.1.js',
				'jquery.validator'		=> 'assets/js/jquery.validator.js',
